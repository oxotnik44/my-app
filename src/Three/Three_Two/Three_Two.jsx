import s from "./Three_Two.module.css";
    ...
    <div className={s.container}>
      ...
      <div className={s.content}>
        <div className={s.text_center_div}>
          <p className={s.text_center}>What do you need your glasses for?</p>
        </div>
      </div>
      <Link to="/Four_One">
        <div className={s.choice_1}>
          <div className={s.div_text_1}>
            <p className={s.text_1}>Near Vision</p>
          </div>
        </div>
      </Link>
      <Link to="/Four_One">
        <div className={s.choice_2}>
          <div className={s.div_text_2}>
            <p className={s.text_1}>Distance Vision</p>
          </div>
        </div>
      </Link>
      <Link to="/Four_One">
        <div className={s.choice_3}>
          <div className={s.div_text_3}>
            <p className={s.text_1}>Multifocal / Progressive</p>
          </div>
        </div>
      </Link>
      <Link to="/Four_One">
