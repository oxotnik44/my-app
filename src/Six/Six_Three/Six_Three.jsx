import s from "./Six_Three.module.css";
...
import face_man_1 from "/React/Project/my-app/src/Project/Img/face_man_1.png";
import face_man_2 from "/React/Project/my-app/src/Project/Img/face_man_2.png";
import face_man_3 from "/React/Project/my-app/src/Project/Img/face_man_3.png";
    ...
    <div className={s.container}>
      ...
      <Link to="/Seven">
        <div className={s.choice_1}>
          <img src={face_man_1} className={s.face_man} />
      ...
      <Link to="/Seven">
        <div className={s.choice_2}>
          <img src={face_man_2} className={s.face_man} />
      ...
      <Link to="/Seven">
        <div className={s.choice_3}>
          <img src={face_man_3} className={s.face_man} />
